(function (app) {
  ...
  var string_en = {
    ...
    SITE_NOTICE: {
      GLOBAL_SALES_NOTICE: '### important notice! \n :radio: The site internal beta has been more than a month. With the active participation of the management team and the small partners, we decided to officially go online on the 26th of this month. Some of the users have been rewarded, please step through the detailed [Opening Notice and Closed Beta list](https://mine.pt/forums/5ae2f216b390dd39dd1287e0/5b2a7b7e7824db1ffb98a628),**{{site_name}}** During the announcement period, the whole station will be free of charge. No. 25 will be deleted. The station will open on time at 26:00 am and gradually release prizes. Please tell us all about it and thank all users for their help and support!',
