(function (app) {
  ...
  var string_en = {
    ...
    SITE_NOTICE: {
      ...
      EXAMINATION_STATUS: '### EXAMINATION STATUS: \n <dl class="dl-horizontal"><dt>Examination time:</dt><dd>{{examination_start_at | date: "yyyy-MM-dd HH:mm"}} - {{examination_end_at | date: "yyyy-MM-dd HH:mm"}}</dd><dt>Incremental data of upload:</dt><dd>{{data_upload | bytes:2}}, finished {{finished_upload | bytes:2}}</dd><dt>Incremental data of download:</dt><dd>{{data_download | bytes:2}}, finished {{finished_download | bytes:2}}</dd><dt>Incremental data of score:</dt><dd>{{data_score}}, finished {{finished_score}}</dd><dt>Examination status:</dt><dd>{{data_status | translate}}</dd></dl>',
