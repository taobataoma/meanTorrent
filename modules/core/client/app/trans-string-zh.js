(function (app) {
  ...
  var string_zh = {
    ...
    SITE_NOTICE: {
      ...
      EXAMINATION_STATUS: '### 考核状态信息: \n <dl class="dl-horizontal"><dt>考核时间区间:</dt><dd>{{examination_start_at | date: "yyyy-MM-dd HH:mm"}} - {{examination_end_at | date: "yyyy-MM-dd HH:mm"}}</dd><dt>增量上传数据:</dt><dd>{{data_upload | bytes:2}}, 已完成 {{finished_upload | bytes:2}}</dd><dt>增量下载数据:</dt><dd>{{data_download | bytes:2}}, 已完成 {{finished_download | bytes:2}}</dd><dt>增量积分:</dt><dd>{{data_score | number: 2}}, 已完成 {{finished_score | number: 2}}</dd><dt>当前考核状态:</dt><dd>{{data_status | translate}}</dd><dt></dt><dd><small>[更多详情请看这里]({{detail_url}}).</small></dd></dl>',
