(function (app) {
  ...
  var string_zh = {
    ...
    SELECT_RESOURCE_TYPE: '&bull; 请选择上传资源类型',
    SELECT_TORRENT_FILE: '&bull; 请选择种子文件',
    SELECT_FILE: '选择文件',
    DO_UPLOAD: '上传',
    ENTER_TMDB_ID: '&bull; 请输入TMDB_ID',
    LOAD_TMDB_INFO: '检索信息',
    TMDB_ID: 'TMDB ID',
    ...
    TMDB_RESOURCE_INFO: '&bull; TMDB 资源信息',
    ...
    ENTER_MUSIC_TITLE: '&bull; 请输入艺人名称和音乐/专辑标题',
    MUSIC_ARTIST: '艺人名称',
    MUSIC_TITLE: '音乐/专辑标题',
    MUSIC_SUB_TITLE: '音乐/专辑副标题',
    SELECT_MUSIC_IMAGE: '&bull; 请选择音乐/专辑封面图片',
    ...
    TMDB_FIELDS: {
      ...
      CAST: '主演：',
      IMAGE_OVERVIEW: '海报欣赏：',
      SCREENSHOTS_OVERVIEW: '截图预览：',
      DIRECTOR: '导演',
      IMAGE_LOADING: '正在加载源图，请稍候...',
