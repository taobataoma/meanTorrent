(function () {
  ...
  UserFollowingController.$inject = ['$scope', '$rootScope', '$state', '$timeout', '$translate', 'Authentication', 'UsersService', 'ScoreLevelService', 'MeanTorrentConfig', 'DebugConsoleService',
    'NotifycationService', 'userResolve'];

  function UserFollowingController($scope, $rootScope, $state, $timeout, $translate, Authentication, UsersService, ScoreLevelService, MeanTorrentConfig, mtDebug,
                               NotifycationService, userResolve) {
    var vm = this;
    ...
    vm.figureOutItemsToDisplay = function (callback) {
      vm.getUserFollowing(vm.currentPage, function (items) {
     ...
     * getUserFollowing
     */
    vm.getUserFollowing = function (p, callback) {
